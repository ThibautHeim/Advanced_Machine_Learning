# Advanced ML : Programming Exercises 1
...
This sampling using reparametrisation trick is done in the $elbo$ function within the $VAE$ class with the method `.rsample()`.
...
in order to have a column of $means$ and a columns of $\log(stds)$ as parameters for the approximated latent distribution $q$.
...
```
        ...
        print("Calculating ELBO on MNIST test set ...")
        with torch.no_grad():
